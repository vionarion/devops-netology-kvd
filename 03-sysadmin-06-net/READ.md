...
3 канала (1,6,11) есть в разделяемой среде WiFi при работе на 2.4 ГГц
...
UDP проигрывает в точности передаваемой информации

В UDP фрагментации пакеты не проверяются, а в TCP идет проверка всех полученных пакетов
